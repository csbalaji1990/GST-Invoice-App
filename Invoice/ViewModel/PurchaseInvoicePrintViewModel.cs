...
{
    public struct PurchaseInvoicePrintItemDetails
    {
    ...
    public struct PurchaseInvoicePrintHsnSacDetails
    {
        public string HsnSac { get; set; }
    ...
    public class PurchaseInvoicePrintViewModel
    {
        ...
        public List<PurchaseInvoicePrintItemDetails> PurchaseInvoicePrintItemDetails { get; set; }
        public List<PurchaseInvoicePrintHsnSacDetails> PurchaseInvoicePrintHsnSacDetails { get; set; }
    }
}
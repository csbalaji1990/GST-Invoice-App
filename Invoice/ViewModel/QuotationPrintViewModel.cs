...
{
    public struct QuotationPrintItemDetails
    {
    ...
    public struct QuotationPrintHsnSacDetails
    {
        public string HsnSac { get; set; }
    ...
    public class QuotationPrintViewModel
    {
        ...
        public List<QuotationPrintItemDetails> QuotationPrintItemDetails { get; set; }
        public List<QuotationPrintHsnSacDetails> QuotationPrintHsnSacDetails { get; set; }
    }
}